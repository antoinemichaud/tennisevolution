...
public class TennisGame1ParametersTest {

    private int player1Score;
    private int player2Score;
    private String expectedScore;

    public TennisGame1ParametersTest(int player1Score, int player2Score, String expectedScore) {
    ...
    public void should_have_right_regular_display() {
        ...
        assertThat(scoreDisplayed).isEqualTo(this.expectedScore);
    }
