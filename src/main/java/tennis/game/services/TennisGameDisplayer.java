...
public abstract class TennisGameDisplayer {
    ...
    protected final Integer servicePlayer;

    TennisGame tennisGame;

    public TennisGameDisplayer(String player1Name, String player2Name, Integer servicePlayer, TennisGame tennisGame) {
    ...
    public String getScore() {
        ...
        if (score.firstPlayerScore() == score.secondPlayerScore()) {
            ...
            if (servicePlayer == 1) {
                ...
                return getScoreAsString(score.secondPlayerScore()) + "-" + getScoreAsString(score.firstPlayerScore());
            }
        }
    }
